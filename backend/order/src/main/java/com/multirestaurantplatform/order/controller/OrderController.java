...
// import io.swagger.v3.oas.annotations.enums.SecuritySchemeIn; // Not directly used here
// import io.swagger.v3.oas.annotations.enums.SecuritySchemeType; // Not directly used here
import io.swagger.v3.oas.annotations.media.Content;
import io.swagger.v3.oas.annotations.media.Schema;
import io.swagger.v3.oas.annotations.responses.ApiResponse;
import io.swagger.v3.oas.annotations.security.SecurityRequirement;
// import io.swagger.v3.oas.annotations.security.SecurityScheme; // Not defined here, but in OpenApiConfig
...
@SecurityRequirement(name = "bearerAuth") // Matches the scheme name in OpenApiConfig
public class OrderController {
    ...
    @Operation(summary = "Confirm an order",
            ...
            responses = {
                    ...
                    // Removed problematic schema reference to avoid inter-module DTO dependency for compilation
                    @ApiResponse(responseCode = "400", description = "Invalid request (e.g., order not in PLACED state)"
                            /* schema = @Schema(implementation = com.multirestaurantplatform.api.dto.error.ErrorResponse.class) */),
    ...
    public ResponseEntity<OrderResponse> confirmOrder(
            ...
            @Parameter(hidden = true) @AuthenticationPrincipal UserDetails userDetails) { // Spring Security injects the principal
    ...
    // - PUT /api/v1/orders/{orderId}/prepare (for RESTAURANT_ADMIN)
